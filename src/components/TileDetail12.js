...
import houseImage from '/Users/shaunhailey/Documents/testBotFrontEnd/botfront/src/images/house12.jpeg'

class TileDetail12 extends Component {
  render() {
    return (
      <div className="tileSuperDetailWrapper">
        ...
        <div className="tileDetailWrapper">
          <div>89 Flounder Ln</div>
          <div>Miami</div>
          <div>FL</div>
          <div>ZIP: 12345</div>
          <div>Folio Number: 123462</div>
          <div>Violation(s):</div>

...
import houseImage from '/Users/shaunhailey/Documents/testBotFrontEnd/botfront/src/images/house16.jpeg'

class TileDetail16 extends Component {
  render() {
    return (
      <div className="tileSuperDetailWrapper">
        ...
        <div className="tileDetailWrapper">
          <div>114976 1st St</div>
          <div>Miami</div>
          <div>FL</div>
          <div>ZIP: 12345</div>
          <div>Folio Number: 123466</div>
          <div>Violation(s):</div>
